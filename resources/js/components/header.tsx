...
const Header: React.FC<HeaderProps> = ({ className = '' }) => {
    ...
    return (
        <header className={`flex items-center justify-between whitespace-nowrap border-b border-solid bg-background text-foreground px-10 py-3 ${className}`}>
            ...
            <div className="flex flex-1 justify-end gap-8">
                <div className="flex items-center gap-9">
                    <Link href="#" className="text-sm font-medium leading-normal hover:text-[#eca413] transition-colors">
                        Browse Collections
                    </Link>
                    <Link href="#" className="text-sm font-medium leading-normal hover:text-[#eca413] transition-colors">
                        Bespoke Design
                ...
                <div className="flex gap-2">
                    <button
                        className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 bg-muted text-foreground gap-2 text-sm font-bold leading-normal tracking-[0.015em] min-w-0 px-2.5 hover:bg-muted/80 transition-colors"
                        aria-label="Search"
                    >
