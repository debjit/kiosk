    ...
    return (
        <div className={className}>
            <div className="flex items-center justify-between px-4 pt-5 pb-3">
                <h2 className="text-[22px] leading-tight font-bold tracking-[-0.015em] text-[#181611]">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 bg-white shadow-sm transition-colors hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50"
            ...
            <div
                ref={scrollRef}
                className={`flex cursor-grab overflow-x-auto select-none [-ms-scrollbar-style:none] [scrollbar-width:none] active:cursor-grabbing [&::-webkit-scrollbar]:hidden ${isDragging ? 'scroll-smooth' : ''}`}
            ...
            >
                <div className="flex items-stretch gap-3 p-4">
                    {collections.map((collection) => (
                        ...
                        >
                            <div
                                className="flex aspect-square w-full cursor-pointer flex-col rounded-lg bg-cover bg-center bg-no-repeat shadow-sm transition-transform duration-300 hover:scale-105 hover:shadow-md"
                                style={{
                            ...
                            />
                            <p className="text-base leading-normal font-medium text-[#181611]">
                                {collection.name}
                            </p>
                        </div>
                    ))}
